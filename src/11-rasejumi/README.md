...
- [Lapu izkārtojums un izmēri](01-lapas.md) (lapu formāti, rakstlaukumi, salocīšanas principi);
- [Izmēru līnijas un izmēri](02-izmeri.md) (izmēru ķēžu un tekstu zīmēšanas noteikumi);
- [Elementu marķējums](03-markejums.md) (konstruktīvo elementu, metināšanas šuvju un griezumu apzīmējumi).
